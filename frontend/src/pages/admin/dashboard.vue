    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-content">
          <h3 class="stat-number" v-if="!loading.stats">{{ stats.totalStudents }}</h3>
      ...
      <div class="stat-card">
        ...
        <div class="stat-content">
          <h3 class="stat-number" v-if="!loading.stats">{{ stats.totalCompanies }}</h3>
          <div v-else class="loading-spinner"></div>
    ...
    <div class="dashboard-grid">
      ...
      <div class="dashboard-card">
        ...
        <div class="card-content">
          ...
          <div v-else-if="error.students" class="error-state">
            <p>{{ error.students }}</p>
          </div>
          <div v-else-if="recentStudents.length === 0" class="empty-state">
            <p>Geen recente studenten gevonden</p>
          </div>
      ...
      <div class="dashboard-card full-width">
        ...
        <div class="card-content">
          ...
          <div v-else-if="error.activity" class="error-state">
            <p>{{ error.activity }}</p>
          </div>
  ...
  methods: {
    async loadStats() {
      try {
        ...
        // Get total companies (mag gewoon getDocs blijven)
        const companiesRef = collection(db, 'companies')
        const companiesSnap = await getDocs(companiesRef)
        this.stats.totalCompanies = companiesSnap.size
      } catch (err) {
