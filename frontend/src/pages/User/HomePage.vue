<template>
  <div class="home">
    <!-- Navigatiebalk -->
    <nav class="navbar">
      <img src="../../../public/Images/ehb-logo.png" alt="Erasmus logo" class="logo" />
      <div class="menu">
    ...
    <section class="intro">
      <p>
        Het ultieme netwerkevent van de design & technologie opleidingen.
    ...
    <section class="bedrijven">
      ...
      <ul class="bedrijf-lijst">
        <li>RaxenIT – Netwerk bedrijf</li>
        <li>Celixe – Consultancy bedrijf</li>
        <li>NTT – Cybersecurity bedrijf</li>
      </ul>
    </section>
