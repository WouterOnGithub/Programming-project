...
const gesitueerdIn = ref('')
const opZoekNaar = ref('')
...
function bevestigGegevens() {
  ...
  foutmelding.value = ''
  alert(`Gegevens succesvol verzonden! Je zoekt naar: ${gekozenZoekterm}`)
}
</script>
    ...
    <form class="formulier-grid" @submit.prevent="bevestigGegevens">
      <div class="form-column">
        <div class="profielfoto-section">
          ...
          <p style="text-align:center;"><strong>{{ bedrijfsnaam || 'Bedrijfsnaam' }}</strong></p>
        </div>

        <div class="form-group">
          <label for="bedrijfsnaam">Bedrijfsnaam *</label>
          <input id="bedrijfsnaam" v-model="bedrijfsnaam" type="text" placeholder="Bijv. Mediahuis" required />
        </div>

        <div class="form-group">
          <label for="gesitueerdIn">Gesitueerd in *</label>
          <input id="gesitueerdIn" v-model="gesitueerdIn" type="text" placeholder="Bijv. Brussel" required />
        </div>
    ...
    />
      ...
      <div class="form-column">
        <div class="form-group">
          ...
          <input id="linkedin" v-model="linkedin" type="url" placeholder="https://linkedin.com/company/jouwbedrijf" />
        </div>
        ...
        <div class="form-group">
          ...
          <div v-if="opZoekNaar === 'Anders'" class="form-group">
            <input
        ...
        <div class="toestemming-richting">
          <input type="checkbox" v-model="toestemming" id="toestemming-checkbox" required />
