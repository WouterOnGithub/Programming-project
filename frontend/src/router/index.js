...
import MijnGesprekkenStudent from '../pages/User/MijnGesprekkenStudent.vue'
...
const userRoutes = [
  ...
  { path: '/Studentgesprekken', name: 'MijnGesprekkenStudent', component: MijnGesprekkenStudent },
]
